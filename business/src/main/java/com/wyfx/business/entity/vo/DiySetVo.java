...
public class DiySetVo {
    ...
    private Integer appLogSys;//终端日志记录状态{0:跟随系统配置;1自定义}
    ...
    public void setVideo(Integer vedio) {
        this.vedio = vedio;
    }
    ...
    public Integer getVideoTimeLimit() {
        return vedioTimeLimit;
    }

    public void setVideoTimeLimit(Integer vedioTimeLimit) {
        this.vedioTimeLimit = vedioTimeLimit;
    }

    public Integer getVideoTimeLimitSys() {
        return vedioTimeLimitSys;
    }

    public void setVideoTimeLimitSys(Integer vedioTimeLimitSys) {
        this.vedioTimeLimitSys = vedioTimeLimitSys;
    }
